...
- Caja chica: movimientos en `petty_cash_transactions`; cierres/dotaciones en `petty_cash_week_meta` + KV `data:pettyCashMeta` (ya no duplicados en `settings:system`).
