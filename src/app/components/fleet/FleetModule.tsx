...
export function FleetModule({ dataset, setDataset, visibleSedes, defaultHomeBase }: FleetModuleProps) {
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-violet-500/25 bg-gradient-to-br from-slate-950/90 via-[#151025] to-slate-900/95 p-4 shadow-xl">
