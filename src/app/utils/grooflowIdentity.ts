...
export const MODULE_IDENTITY: Record<ViewType, ModuleIdentity> = {
  ...
  rrhhAreas: id({
    ...
    subtitle: 'Gestión de áreas organizacionales y sedes operativas.',
    icon: Building2,
  }),
  rrhhPuestos: id({
    ambientA: GF_PALETTE.indigo,
    ...
    subtitle: 'Cargos y puestos laborales de la organización.',
    icon: Briefcase,
  }),
  rrhhTurnosCatalog: id({
    ambientA: GF_PALETTE.cyan,
    ambientB: GF_PALETTE.purple,
    accent: '#22d3ee',
    accentGlow: 'rgba(34, 211, 238, 0.45)',
    title: 'Catálogo de Turnos',
  ...
  menuConfig: id({
    ...
    subtitle: 'Estructura de módulos y navegación del sistema.',
    icon: Menu,
  }),
  menuAssignment: id({
    ambientA: GF_PALETTE.indigo,
